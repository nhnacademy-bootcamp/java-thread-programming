...
link:exam-07-01.adoc[Exam-7-1. Thread intance를 생성하여 실행 전 상태를 확인해 보자]
...
link:exam-07-02.adoc[Exam-7-2. Thread intance를 생성하여 RUNNABLE 상태를 확인해 보자]
...
link:exam-07-03.adoc[Exam-7-3. Thread intance를 생성하여 BLOCKED 상태를 확인해 보자]
...
link:exam-07-04.adoc[Exam-7-4. Thread를 실행 시킨 후 종료되길 기다리는 WAITING 상태를 확인해 보자]
...
link:exam-07-05.adoc[Exam-7-5. Thread를 실행 시킨 후 일정 시간 sleep 상태를 만들고, TIMED_WAITING 상태를 확인해 보자]
...
link:quiz-07-01.adoc[Quiz-7-1. sleep()를 이용해 일정 시간 간격으로 tick을 출력하는 ticker를 만들어라]
...
link:quiz-07-02.adoc[Quiz-7-2. Thread를 실행시키고, 모든 thread가 종료되면 프로그램이 종료되도록 하라]
