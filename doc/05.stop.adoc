...
link:quiz-05-01.adoc[Quiz-01. RunnableCounter class에 중지를 위한 field와 method를 추가하여 동작을 확인하라]
...
link:quiz-05-02.adoc[Quiz-02. Thread의 interrupt를 이용해 외부에서 중지하도록 만들어라]
