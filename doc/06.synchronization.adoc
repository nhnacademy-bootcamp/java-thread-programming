...
link:exam-06-01.adoc[Exam-01. 공유 count를 갖는 SharedCounter class를 만들어 race condition 문제에 대해 확인해 보자]
...
link:exam-06-02.adoc[Exam-02. Exam-01에서 발생했던 race condition 문제를 syncrhronized keyword를 이용해 해결해 보자]
...
link:exam-06-03.adoc[Exam-03. Exam-01에서 발생했던 race condition 문제를 static instance를 생성하고, syncrhronized keyword를 이용해 해결해 보자]
